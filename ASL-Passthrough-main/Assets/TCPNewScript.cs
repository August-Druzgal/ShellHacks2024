...
public class TCPNewScript : MonoBehaviour
{
    ...
    void ReceiveData()
    {
        try
        {
            while (isConnected)
            {
                ...
                List<DetectedObjectJack> objects = JsonUtility.FromJson<DetectedObjectListJack>(jsonString).objects;
...
[Serializable]
public class DetectedObjectJack
{
    public string label;
    public int x;
    public int y;
...
[Serializable]
public class DetectedObjectListJack
{
    public List<DetectedObjectJack> objects;
}